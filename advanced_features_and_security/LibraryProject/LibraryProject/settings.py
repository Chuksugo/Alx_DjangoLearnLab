...
SECRET_KEY = 'django-insecure-6-lehz_$5r&6ipkh7fovn#9k--p#af$xeg+*tgw$7ab8a7a9j_'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'relationship_app/templates/relationship_app',  # Adjusted path
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Security settings to enhance protection against attacks
